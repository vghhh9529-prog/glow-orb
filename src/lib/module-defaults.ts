...
export const MODULE_DEFAULTS: Record<ModuleKey, Record<string, unknown>> = {
  ...
  protection: {
    ...
    rules: {
      ...
      roleUpdate: { enabled: false, limit: 5, windowSeconds: 30, punishment: "removeRoles" },
      ...
      memberUpdate: { enabled: false, limit: 5, windowSeconds: 30, punishment: "removeRoles" },
      massRoleChange: { enabled: false, limit: 3, windowSeconds: 30, punishment: "removeRoles" },
      webhookCreate: { enabled: false, limit: 2, windowSeconds: 30, punishment: "removeRoles" },
    },
  },
  logging: {
    channelId: "",
  ...
  tickets: {
    ...
    panelDescription: "Open a private support ticket and our team will be with you shortly.",
    panelColor: "#7C5CFF",
    panelMessageId: "",
